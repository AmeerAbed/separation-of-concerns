...
const arithmeticOperators_1_Tests = [
  ...
  { name: 'fourth', args: [12, '12', .4], expected: null },
...
const challenge = (a, b, c) => -(a + b) * c;

arithmeticOperators_1_Tests.forEach(function evaluateTestCases(test) {
  console.assert(
